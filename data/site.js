APP.data = {
	...
	"about": {
		...
		"skills": "<p>Main skills: Sound Design/Implementation, FMOD Studio, Unity, Reaper</p><p>Additional skills: Adobe Suite (Photoshop, Illustrator, After Effects, Premiere), Python, basic C#</p>",
